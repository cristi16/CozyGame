    ...
    void Update()
    {
		for(int i = 0; i < 4; ++i)
        {
            ...
            else if(GameManager.Instance != null)
            {
                ...
                GameManager.Instance.players[i].dropWeapon = state.Buttons.B == ButtonState.Pressed;
                GameManager.Instance.players[i].pickUpWeapon = state.Buttons.Y == ButtonState.Pressed;
